...
import frc.robot.subsystem.telemetry.PositionSBTab;
...
public class DisplayManager {
    ...
    private PositionSBTab positionDisplay;
    ...
    */
    ...
    {
        positionDisplay = new PositionSBTab(p);
        subsystemUpdateList.add(positionDisplay);
    }
